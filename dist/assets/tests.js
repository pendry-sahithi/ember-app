...
define('emtasks/tests/lint/app.lint-test', [], function () {
  'use strict';
  ...
  QUnit.test('controllers/tasks/edit.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'controllers/tasks/edit.js should pass ESLint\n\n10:43 - \'id\' is not defined. (no-undef)');
  });
  ...
  QUnit.test('routes/tasks/edit.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'routes/tasks/edit.js should pass ESLint\n\n2:8 - \'task\' is defined but never used. (no-unused-vars)');
  });
...
define('emtasks/tests/lint/templates.template.lint-test', [], function () {
  'use strict';

  QUnit.module('TemplateLint');

  QUnit.test('emtasks/templates/application.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'emtasks/templates/application.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('emtasks/templates/tasks.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'emtasks/templates/tasks.hbs should pass TemplateLint.\n\nemtasks/templates/tasks.hbs\n  9:21  error  you must use double quotes in templates  quotes\n');
  });

  QUnit.test('emtasks/templates/tasks/edit.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'emtasks/templates/tasks/edit.hbs should pass TemplateLint.\n\nemtasks/templates/tasks/edit.hbs\n  4:12  error  Incorrect indentation of attribute \'type\' beginning at L4:C12. Expected \'type\' to be at L5:C6.  attribute-indentation\n  4:24  error  Incorrect indentation of attribute \'class\' beginning at L4:C24. Expected \'class\' to be at L6:C6.  attribute-indentation\n  4:45  error  Incorrect indentation of attribute \'placeholder\' beginning at L4:C45. Expected \'placeholder\' to be at L7:C6.  attribute-indentation\n  4:68  error  Incorrect indentation of attribute \'value\' beginning at L4:C68. Expected \'value\' to be at L8:C6.  attribute-indentation\n  4:85  error  Incorrect indentation of close curly braces \'}}\' for the component \'{{input}}\' beginning at L4:C85. Expected \'{{input}}\' to be at L9:C4.  attribute-indentation\n  12:15  error  Incorrect indentation of attribute \'placeholder\' beginning at L12:C15. Expected \'placeholder\' to be at L13:C6.  attribute-indentation\n  12:45  error  Incorrect indentation of attribute \'class\' beginning at L12:C45. Expected \'class\' to be at L14:C6.  attribute-indentation\n  12:66  error  Incorrect indentation of attribute \'value\' beginning at L12:C66. Expected \'value\' to be at L15:C6.  attribute-indentation\n  12:89  error  Incorrect indentation of close curly braces \'}}\' for the component \'{{textarea}}\' beginning at L12:C89. Expected \'{{textarea}}\' to be at L16:C4.  attribute-indentation\n');
  });

  QUnit.test('emtasks/templates/tasks/new.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'emtasks/templates/tasks/new.hbs should pass TemplateLint.\n\n');
  });
});
define('emtasks/tests/lint/tests.lint-test', [], function () {
  'use strict';
  ...
  QUnit.test('unit/controllers/tasks/edit-test.js', function (assert) {
    assert.expect(1);
  ...
  QUnit.test('unit/routes/tasks/edit-test.js', function (assert) {
    assert.expect(1);
